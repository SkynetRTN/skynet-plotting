...
export function cluster2(): [Handsontable, Chart, ModelForm] {
  document
    ...
    .insertAdjacentHTML(
      "beforeend",
      '<form title="Cluster Diagram 2" id="cluster-form">\n' +
      '<div class="row">\n' +
  ...
  const cluster2Form = document.getElementById("cluster-form") as Cluster2Form;
  const modelForm = document.getElementById("model-form") as ModelForm;
  linkInputs(cluster2Form["d"], cluster2Form["d_num"], 0.1, 100, 0.01, 3, true);
  linkInputs(cluster2Form["err"], cluster2Form["err_num"],
    0,
    1,
    0.01,
    1,
  ...
  linkInputs(
    cluster2Form["red"], cluster2Form["red_num"],
    0,
    1,
    0.01,
    0,
...
export function cluster2FileUpload(
  ...
  reader.onload = () => {
    const cluster2Form = document.getElementById("cluster-form") as Cluster2Form;
    const modelForm = document.getElementById("model-form") as ModelForm;
    // console.log(cluster2Form.elements['d'].value);
    cluster2Form["d"].value = Math.log(3).toString();
    // console.log(cluster2Form.elements['d'].value);
    modelForm["age"].value = "6.6";
    cluster2Form["red"].value = "0";
    modelForm["metal"].value = "-3.4";
    cluster2Form["d_num"].value = "3";
    modelForm["age_num"].value = "6.6";
    cluster2Form["red_num"].value = "0";
...
function updateScatter(
  ...
  let err = parseFloat(cluster2Form["err_num"].value);
