 ...
 */
export function cluster4(): [Handsontable, Chart[], ModelForm, graphScale] {
  ...
  let graphMinMax = new graphScale(4);
  ...
  window.onresize = function () {
    setTimeout(function () {
      ...
      myChart3.data.datasets[2].backgroundColor = HRrainbow(myChart1,
            modelForm["red3"].value, modelForm["blue3"].value)
      myChart4.data.datasets[2].backgroundColor = HRrainbow(myChart2,
  ...
  const update = function () {
    ...
    updateScatter(hot, [myChart1, myChart2, myChart3, myChart4], clusterForm, modelForm, [2, 2], graphMinMax);
  };
  // link chart to table
  hot.updateSettings({
    afterChange: update,
  ...
  clusterForm.oninput = throttle(
    function () { updateScatter(hot, [myChart1, myChart2, myChart3, myChart4], clusterForm, modelForm, [2, 2], graphMinMax); },
    frameTime);
  ...
  modelForm.oninput = throttle(function () {
    updateHRModel(modelForm, hot, [myChart1, myChart2, myChart3, myChart4], (chartNum: number) => {
      updateScatter(hot, [myChart1, myChart2, myChart3, myChart4], clusterForm, modelForm, [2, 2], graphMinMax, chartNum);}
    );
   }, 100);
  ...
  updateLabels(myChart3, document.getElementById("chart-info-form") as ChartInfoForm);
