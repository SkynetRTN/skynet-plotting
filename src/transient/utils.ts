...
export const ZERO_POINT_VALUES: { [key: string]: number } = {
    ...
    'U': 1755, 'B': 4.063, 'V': 3.636, 'R': 3.064,
    'I': 2.416, 'J': 1.589, 'H': 1.021, 'K': 0.640,
...
export const FILTERCOLORS: { [key: string]: string } = {
    ...
    'I': '#4424D6', 'Y': '#347C98', 'J': '#66B032', 'H': '#FC600A',
    'K': '#FE2712', "u\'": '#4424D6', "g\'": '#347C98', "r\'": '#FC600A',
    "i\'": '#8601AF', "z\'": '#0247FE', 'uprime': '#4424D6', 'gprime': '#347C98',
    'rprime': '#FC600A', 'iprime': '#8601AF', 'zprime': '#0247FE'
}
