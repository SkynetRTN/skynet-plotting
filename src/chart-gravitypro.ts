...
import {backgroundPlugin} from "./chart-gravity-utils-beta/background-image";
import {get_grav_spectrogram_server, get_grav_strain_server} from "./chart-gravity-utils-beta/chart-gravity-file"
import Handsontable from "handsontable";
import {dummyData} from "./chart-gravity-utils-beta/chart-gravity-dummydata";
import {colors, tableCommonOptions} from "./config";
import {play, saveSonify} from "./sonification";
...
export function gravityPro(): [Handsontable, Chart[], gravityProClass] {
    ...
    gravityModelForm.oninput = throttle(
        function () {
            updateGravModelData(gravityModelForm, (modelData: number[][], freqData: number[][], totalMassDivGrid: number) =>
