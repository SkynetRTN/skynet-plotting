...
import {linkInputs, throttle, updateLabels} from "./util";
...
import {httpGetAsync, modelFormKeys, pointMinMax} from "./chart-cluster-utils/chart-cluster-util";
...
export function cluster0(): [Handsontable, Chart[], ModelForm, graphScale] {
    ...
    myChart.options.plugins.zoom.zoom.onZoom = () => {
        graphControl.zoompanDeactivate(modelForm)
    }
...
export function updateHRModelSim(modelForm: ModelForm, hot: Handsontable, charts: Chart[], callback: Function = () => {
